...
As a general rule, the Technical Meetings are held on the 2nd SAT of the month and the Nomikai Meetings are usually held on the 4th FRI, every month. There are, of course, exceptions to this rule, so it is best to keep an eye on the mailing list, or check back here for date/venue changes as the date approaches. 

1. Technical Meeting
1. cancelled
next meeting: May 14, 2011 (Saturday)
...
{{Meetings:Categories|year=2011|month=04}}