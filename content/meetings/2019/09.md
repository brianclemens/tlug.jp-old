...
1. Event
Celebrate TLUG's 25th anniversary with a BBQ and cruise
...
Payment details
(paid by bank transfer before 9th September)

三井住友銀行 横浜中央支店 普通 6939742 <br/>
ミドルトン　エドワ－ド

Please also register on Doorkeeper or reply to the announcement on the
mailing list so we can keep track of who's coming and who's paid.

https://tlug.doorkeeper.jp/events/96827

The 5000 yen is for the Weber Park BBQ course and must be prepaid so
...
We'll start out with a barbecue and open bar at Weber Park in
...
the Asahi Beer HQ for a nijikai.

This event is open to all Linux users and friends, and is to celebrate
TLUG's 25th Anniversary. Even if you're not a Linux user or a LUG
member, but want to hang out with Linux people, please come.

1. Contact Info
For directions or information before the meeting, call:
- Edward: 090-3689-0292

{{Meetings:Categories|year=2019|month=09}}