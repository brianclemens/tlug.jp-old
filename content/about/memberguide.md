...
1. provide quality information on Linux related technology to its membership, and 
1. serve as a gateway between the Japanese Linux community and the rest of the Linux world. 
...
The TLUG web site is accessible at [http://www.tlug.jp](http://www.tlug.jp)
...
1. Using TLUG Resources

The TLUG server currently offers the following lists:<br />
- lingo
- tlug
- tlug-admin
- tlug-digest
...
1. Appropriate Material for TLUG Mailing Lists
...
1. Inappropriate Material for Mailing Lists
...
1. Strategies for Dealing With the Mailing List Volume
...
1. Subscribe to the TLUG Digest
