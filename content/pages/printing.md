---
categories:
- Japanese_And_Linux_Howto|Printing
date: '2026-02-05'
draft: false
title: Printing
---
...
Much of this information was taken from an [excellent page](http://www.jw-stumpel.nl/stestu.html)on using multilingual text in Linux by JWS.  
...
Another way to do it is to use the very good [paps program](http://paps.sourceforge.net/).
...
I use HP printers both at work and home.  The generic laserjet and deskjet drivers didn't work properly with paps, I had to install the hpijs program (available in most distributions) to get more sophisticated ppds.  If it's not available in your distribution, you can get the source code from [the HPLIP page](http://hplip.sourceforge.net/).  (The HPLIP package includes hpijs.)
