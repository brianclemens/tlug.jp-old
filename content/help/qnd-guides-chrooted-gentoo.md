...
1. Free Space Requirements
Before you can install Gentoo into a jail, you should verify that you have enough space. The core system install requires just about 1GB of space. Of course, if you are planning to install hefty software packages like [X](http://packages.gentoo.org/search/?sstring=xorg-x11), [OpenOffice.org](http://packages.gentoo.org/search/?sstring=openoffice), [Firefox](http://packages.gentoo.org/search/?sstring=mozilla-firefox), or a full [LAMP](http://en.wikipedia.org/wiki/LAMP_%28software_bundle%29) stack, you will need to allow more free space. As a guide, here are some recommendations based on the feedback of people who have followed these steps:
- Servers:
** LAMP web application server + mailserver: 2GB
- Workstations / Desktops:
** X with FluxBox window manager (i.e. no GNOME / KDE bloat): 5GB

1. Obtaining Gentoo Installation Media
You will need, at the very least, a Gentoo stage3 tarball. You probably also want a Portage snapshot tarball. Both of these wonderful things can be located on your [favourite Gentoo mirror](http://www.gentoo.org/main/en/mirrors.xml):
...
1. Creating the chroot Jail and Installing Gentoo into It
...
1. Entering the Jail for the First Time
...
1. Starting and Stopping Faketoo
