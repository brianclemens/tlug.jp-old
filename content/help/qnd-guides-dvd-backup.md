---
categories:
- Linux_Help:QND-Guides|DVD_Backup
date: '2026-02-05'
draft: false
title: Linux Help - QND-Guides - DVD Backup
---
...
You will need to download and install the following tools. For help on this, see the [Linux_Help:QND-Guides:Finding_and_Installing_Software](/linux-help/qnd-guides/finding-and-installing-software/) or your distribution's documentation.
...
- *mkisofs*, from the [cdrtools](http://freshmeat.net/projects/cdrecord/) project
- [MPlayer](http://www.mplayerhq.hu/) is not absolutely necessary, but the ability to preview before you burn is likely to save you a few coasters.
- [cdrecord-ProDVD](ftp://ftp.berlios.de/pub/cdrecord/ProDVD/)

1. Dual-layer DVDs
Backing up dual-layer DVDs onto single-layer media is a little bit harder. In addition to mkisofs, MPlayer (not optional for dual-layer DVD backup), and cdrecord-ProDVD from the [DVDs](#Single-layer)(/#single-layer dvds/) list, you will need:
- *lsdvd*, from the [StreamDVD](http://www.badabum.de/streamdvd.html) project
- [Perl 5](http://www.cpan.org/) and the [DateTime](http://cpan.uwinnipeg.ca/module/DateTime) CPAN module
- *tcextract* and *tcrequant*, both from the [Transcode](http://www.transcoding.org/) project
- *ifo_dump* (called *ifo_dump_ogle* on Gentoo systems) from the [Ogle](http://www.dtek.chalmers.se/groups/dvd/) project; not strictly required, but your subtitles will look strange without it
- *dvdauthor*, *spumux*, and *spuunmux*, all from the [dvdauthor](http://dvdauthor.sourceforge.net/) project
- *mplex*, from the [MJPEG Tools](http://mjpeg.sourceforge.net/) project
...
[DVD_Backup](/category/linux-help/qnd-guides/)