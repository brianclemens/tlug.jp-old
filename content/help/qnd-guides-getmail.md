...
Note that this page is about getmail version 4.x. Debian and some others, as of October 2004 are still using version 3.x For information about 3.x please see my getmail [3.x page](http://home.nyc.rr.com/computertaijutsu/getmail3.html).  (As it is now 2007, however, I doubt that any distributions still has it.  The author of getmail strongly recommends that you upgrade.)
...
1. Using Getmail with Gmail
As [Gmail](http://mail.google.com/) becomes more and more popular, folks are often making use of its POP download feature, enabling you to receive Gmail email on your normal client.
...
1. Setting up a Cronjob for Getmail
...
1. A Few Gotchas (Mostly Fixed by Now)
...
1. References
- [Getmail home page](http://pyropus.ca/software/getmail/)
- [A more detailed page of mine](http://home.nyc.rr.com/computertaijutsu/getmail.html)
- <pre>man crontab</pre>
